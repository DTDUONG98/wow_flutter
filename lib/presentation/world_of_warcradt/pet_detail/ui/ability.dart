          ...
          child: ListTile(
              ...
              title: Column(
                mainAxisAlignment: MainAxisAlignment.start,
                    ...
                    children: [
                  Text('name: $name' , style: TextStyle(color: Colors.black38, fontWeight: FontWeight.bold),),
                  Text('slot: $slot' , style: TextStyle(color: Colors.black38, fontWeight: FontWeight.bold),),
                  Text('required level: $requiredLevel' , style: TextStyle(color: Colors.black38, fontWeight: FontWeight.bold),),
              ],)
          ),
        ),
      ),
